...
export const mainBoard: Board = [
  ...
  [fieldingsCell, fieldingsCell, path(4,[],noTrap),  fieldingsCell,  fieldingsCell,  fieldingsCell,  fieldingsCell,   fieldingsCell,   fieldingsCell,   fieldingsCell],
  ...
  [fieldingsCell, fieldingsCell, path(12,[],noTrap), path(11,[],noTrap), path(10,[],quicksand), fieldingsCell,  path(24,[],noTrap),  path(23,[],noTrap),  fieldingsCell,   path(31,[],noTrap)],
  ...
  [fieldingsCell, fieldingsCell, path(15,[],noTrap), path(16,[],snake), path(17,[],noTrap), path(18,[],noTrap), path(19,[],quicksand),  path(20,[],noTrap),  fieldingsCell,   path(34,[],noTrap)],
